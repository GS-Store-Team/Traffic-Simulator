...
//                    check = true;
//                }
//                if (isInRadius(new PointDTO(buildingDTO.getLocation().getX() + (double) GlobalSettings.buildingWidth / 2,
//                        buildingDTO.getLocation().getY() + (double) GlobalSettings.buildingWidth / 2), roadDTO.getStart()))
//                    map.put(buildingDTO.getLocation(), roadDTO.getStart());
//
//                if (isInRadius(new PointDTO(buildingDTO.getLocation().getX() + (double) GlobalSettings.buildingWidth / 2,
//                        buildingDTO.getLocation().getY() + (double) GlobalSettings.buildingWidth / 2), roadDTO.getEnd()))
