...
public class WorkplaceBuilding extends Building {
    public WorkplaceBuilding(Coordinates upLeftCorner, Coordinates downRightCorner, String name, String street, String index) {
        super(upLeftCorner, downRightCorner, name, street, index);
    }

    public WorkplaceBuilding(Coordinates upLeftCorner, Coordinates downRightCorner, String name, String street, String index, ParkingZone parkingZone) {
