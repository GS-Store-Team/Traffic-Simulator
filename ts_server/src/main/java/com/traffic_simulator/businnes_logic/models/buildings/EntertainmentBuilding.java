...
public class EntertainmentBuilding extends Building {
    public EntertainmentBuilding(Coordinates upLeftCorner, Coordinates downRightCorner, String name, String street, String index) {
        super(upLeftCorner, downRightCorner, name, street, index);
    }

    public EntertainmentBuilding(Coordinates upLeftCorner, Coordinates downRightCorner, String name, String street, String index, ParkingZone parkingZone) {
