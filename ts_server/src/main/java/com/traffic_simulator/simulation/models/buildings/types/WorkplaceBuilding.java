...
public class WorkplaceBuilding extends Building {
    public WorkplaceBuilding(Coordinates upLeftCorner, Coordinates downRightCorner, Coordinates center, String name, String street, String index) {
        super(upLeftCorner, downRightCorner, center, name, street, index);
    }

    public WorkplaceBuilding(Coordinates upLeftCorner, Coordinates downRightCorner, Coordinates center, String name, String street, String index, ParkingZone parkingZone) {
