...
public class EntertainmentBuilding extends Building {
    public EntertainmentBuilding(Coordinates upLeftCorner, String name, String street, String index, BuildingType type) {
        super(upLeftCorner, name, street, index, type);
    }

    public EntertainmentBuilding(Coordinates upLeftCorner, String name, String street, String index, ParkingZone parkingZone) {
